<?php
	...
	if($resultado->num_rows > 0 ){
		...
		$titulosColumnas = array('identificacionCliente', 'nombreCliente', 'apellidoCliente', 'direccionCliente', 'telefonoCliente', 'correoCliente', 'nombre_Usuario', 'passwordCliente');
